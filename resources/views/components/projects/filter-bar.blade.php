...
<form method="GET" action="{{ request()->url() }}"
    ...
    <div class="flex flex-col gap-1 min-w-[110px]">
        <label for="score_min" class="text-xs font-medium text-gray-500">Min score</label>
    ...
    <div class="flex flex-col gap-1 min-w-[160px]">
        <label for="proposer_id" class="text-xs font-medium text-gray-500">Proposer</label>
