            ...
            <div class=" bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between gap-4 mb-4">
                        <x-projects.countProjects text="Propositions" :projets="$counts->get('proposition', 0) + $counts->get('révision', 0)" route="propositions" />
                        ...
                        <x-projects.countProjects text="En cours" :projets="$counts->get('en cours', 0)"
                            route="en-cours" />
                        <x-projects.countProjects text="Frigo" :projets="$counts->get('archivé', 0) + $counts->get('complété', 0)" route="frigo" />
                    </div>
