            ...
            <section class="flex flex-col gap-4 p-4">
                ...
                @endif
                    <div class="flex justify-between">
                        <h3 class="text-2xl font-medium text-white mb-6">{{ $stage->title() }}</h3>
                        <button @click="showFilter = !showFilter" class="p-2 mb-4 inline-block rounded-lg border border-white/25 bg-white/10 px-4.5 py-2 text-sm font-medium text-white hover:bg-white/20 transition-colors">
                            Filtrer
                        </button>
                    </div>
